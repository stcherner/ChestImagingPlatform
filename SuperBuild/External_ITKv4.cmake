...
if(NOT DEFINED ITK_DIR AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  if (USE_ITK_4.10)
    ...
    set(ITKv4_URL "https://github.com/Slicer/ITK/archive/16df9b689856cd4a8dd22a2cef92f5ee7222da0c.tar.gz")  # last known tag working in the cluster
  else()
    set(ITKv4_URL "https://github.com/Slicer/ITK/archive/87f5d83f15929900aea038abed43d46a14b69886.tar.gz")  # slicer-v4.13.1-2018-08-17-cdc3e57
  endif()
